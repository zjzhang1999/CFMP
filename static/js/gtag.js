...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                "function": "__gct",
                "vtp_trackingId": "G-4Y34PZ3XBE",
                "vtp_sessionDuration": 0,
                "tag_id": 1
            }, {
                "function": "__zone",
                "vtp_childContainers": ["list", ["map", "publicId", "UA-111985496-2"]],
                ...
                "vtp_instanceDestinationId": "G-4Y34PZ3XBE",
                "tag_id": 9
            }, {
...
*/
    ...
    ni.oe = Number("0") || 0;
    ni.ia = "dataLayer";
    ni.fk = "ChEIgNLMqgYQh+3G4tKN54fBARIlAJW0Pilaw2YmfoqIhyc+UB/zVcZT7kmAvNJaWXyiU6tfiCknYBoCKJc\x3d";
    var qi = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    aa.isActive = function(a, b) {
        ...
        if (!c)
            return !0;
        if (!this.isActive([c.Eh], b))
            return !1;
        for (var e = 0; e < c.Xe.length; e++)
            if (this.C[c.Xe[e]].kd(b))
                return !0;
        return !1
    }
    ;
    ...
    function hE() {
        ...
        a.set("containerId", 'G-4Y34PZ3XBE'),
        a.set("version", '1'),
    ...
    function() {
        ...
        (function(c) {
            ...
            if (c.vtp_gtmTagId in a)
                Cw(a[c.vtp_gtmTagId], c.vtp_gtmEventId, d);
            else if (d) {
